      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-12 relative z-10">
        ...
        <article className="max-w-none relative backdrop-blur-xl bg-[#fbabff]/[0.02] p-8 md:p-12 rounded-3xl border border-[#fbabff]/10 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <section className="space-y-8 text-[#e5e1e4]/90 leading-relaxed text-base md:text-lg">
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-8">AGREEMENT TO OUR LEGAL TERMS</h2>
              <p className="mb-4">
                We are <strong>Utkarsh Gopal Bhartariya</strong>, doing business as <strong>Tip Root</strong> (&apos;<strong>Company</strong>&apos;, &apos;<strong>we</strong>&apos;, &apos;<strong>us</strong>&apos;, or &apos;<strong>our</strong>&apos;), a company registered in India at __________, Hyderabad, Telangana.
              </p>
              <p className="mb-4">
                We operate the website <a href="https://tip-root.in" className="text-[#fbabff] hover:underline">https://tip-root.in</a> (the &apos;<strong>Site</strong>&apos;), the mobile application Tip Root SPC App (the &apos;<strong>App</strong>&apos;), as well as any other related products and services that refer or link to these legal terms (collectively, the &apos;<strong>Services</strong>&apos;).
              </p>
              <p className="mb-4">
                Tip Root provides technology infrastructure and notification overlays that allow viewers to send tips directly to content creators via the Unified Payments Interface (UPI). We act solely as a technology provider and do not process, hold, or touch user funds at any point, nor do we act as a payment aggregator or financial intermediary.
              </p>
              <p className="mb-4">
                You can contact us by email at <a href="mailto:hi@tip-root.in" className="text-[#fbabff] hover:underline">hi@tip-root.in</a> or by mail to __________, Hyderabad, Telangana, India.
              </p>
              <p className="mb-4">
                These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&apos;<strong>you</strong>&apos;), and Utkarsh Gopal Bhartariya, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
              </p>
              <p className="mb-4">
                By posting a notice on our website/dashboard.
              </p>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">TABLE OF CONTENTS</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">1. OUR SERVICES</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">2. INTELLECTUAL PROPERTY RIGHTS</h2>
              
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Our intellectual property</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Your use of our Services</h3>
              <p className="mb-4">
              ...
              <p className="mb-4">
                If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:hi@tip-root.in" className="text-[#fbabff] hover:underline">hi@tip-root.in</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
              </p>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Your submissions and contributions</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Copyright infringement</h3>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">3. USER REPRESENTATIONS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">4. USER REGISTRATION</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">5. PURCHASES AND PAYMENT</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">6. PROHIBITED ACTIVITIES</h2>
              <p className="mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-[#9f8b9d] mb-4">
                ...
                <li>Use the platform to facilitate money laundering, fraudulent peer-to-peer transfers, or any illegal financial activities.</li>
              </ul>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">7. USER GENERATED CONTRIBUTIONS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">8. CONTRIBUTION LICENCE</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">9. GUIDELINES FOR REVIEWS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">10. MOBILE APPLICATION LICENCE</h2>
              
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Use Licence</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Apple and Android Devices</h3>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">11. SOCIAL MEDIA</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">12. THIRD-PARTY WEBSITES AND CONTENT</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">13. SERVICES MANAGEMENT</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">14. PRIVACY POLICY</h2>
              <p className="mb-4">
                We care about data privacy and security. Please review our Privacy Policy: <strong><a href="https://tip-root.in/privacy" className="text-[#fbabff] hover:underline">https://tip-root.in/privacy</a></strong>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, then through your continued use of the Services, you are transferring your data to India, and you expressly consent to have your data transferred to and processed in India.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">15. COPYRIGHT INFRINGEMENTS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">16. TERM AND TERMINATION</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">17. MODIFICATIONS AND INTERRUPTIONS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">18. GOVERNING LAW</h2>
              <p className="mb-4">
                These Legal Terms shall be governed by and defined following the laws of India. Utkarsh Gopal Bhartariya and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">19. DISPUTE RESOLUTION</h2>
              
              <h3 className="text-xl font-medium text-white mb-2 mt-6">Informal Negotiations</h3>
              <p className="mb-4">
                To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a &apos;Dispute&apos; and collectively, the &apos;Disputes&apos;) brought by either you or us (individually, a &apos;Party&apos; and collectively, the &apos;Parties&apos;), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
              </p>

              <h3 className="text-xl font-medium text-white mb-2 mt-6">Binding Arbitration</h3>
              <p className="mb-4">
                If the parties are unable to resolve the dispute through informal negotiation, the dispute shall be finally resolved by arbitration in accordance with the United Nations Commission on International Trade Law Arbitration Rules in force at the time of commencement of the arbitration. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be Hyderabad, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.
              </p>

              <h3 className="text-xl font-medium text-white mb-2 mt-6">Restrictions</h3>
              <p className="mb-4">
                The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilise class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
              </p>

              <h3 className="text-xl font-medium text-white mb-2 mt-6">Exceptions to Informal Negotiations and Arbitration</h3>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">20. CORRECTIONS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">21. DISCLAIMER</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">22. LIMITATIONS OF LIABILITY</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">23. INDEMNIFICATION</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">24. USER DATA</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">26. MISCELLANEOUS</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4 mt-12">27. CONTACT US</h2>
              <p className="mb-4">
              ...
              <address className="not-italic text-[#9f8b9d] pl-4 border-l-2 border-[#fbabff]/30 mb-4">
                ...
                India<br />
                <a href="mailto:hi@tip-root.in" className="text-[#fbabff] hover:underline">hi@tip-root.in</a>
              </address>
            </div>
          </section>
        </article>
